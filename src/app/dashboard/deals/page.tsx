          ...
          {deals.map((deal) => {
            ...
            return (
              <div
                ...
                className="bg-slate-900/50 border border-white/10 hover:border-emerald-500/40 rounded-2xl p-5 cursor-pointer transition-all hover:shadow-xl hover:shadow-emerald-500/5 flex flex-col justify-between space-y-4"
              >
                <div>
                  <div className="flex items-start justify-between gap-2 mb-2">
                    <span className={`text-[11px] font-semibold px-2.5 py-1 rounded-full border ${stageConfig.color}`}>
                      {stageConfig.label}
                    </span>
                  ...
                  <h3 className="text-base font-semibold text-white line-clamp-1">{deal.title}</h3>
