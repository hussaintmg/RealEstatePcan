  ...
  return (
    <div className="relative w-full h-[550px] bg-slate-950 rounded-2xl overflow-hidden border border-slate-800 shadow-2xl">
      ...
      <div className="absolute top-4 left-4 right-4 flex items-center justify-between pointer-events-none">
        {/* Mode Selector */}
        <div className="flex items-center gap-1.5 p-1 bg-slate-900/80 backdrop-blur-md rounded-xl border border-slate-800 pointer-events-auto shadow-lg">
          <button
      ...
      {rooms.length > 0 && (
        <div className="absolute bottom-4 left-4 pointer-events-auto flex items-center gap-2 bg-slate-900/80 backdrop-blur-md px-3 py-2 rounded-xl border border-slate-800 shadow-lg">
          ...
          <select
            ...
            className="bg-slate-800 text-white text-xs rounded-lg px-2.5 py-1 border border-slate-700 focus:outline-none focus:border-blue-500"
          >
            {rooms.map((r, i) => (
